...
function M.keymappings()
    ...
    local mappings = {
        ["r"] = {
            name = "Run",
            r = { ":update<CR>:sp term://nodemon -e js %<CR>", "Nodemon watch - Javascript" },
            d = { ":update<CR>:sp term://nodemon -e yarn start<CR>", "Nodemon yarn" },
            w = { ":update<CR>:sp term://nodemon -e ts %<CR>", "Nodemon watch - Typescript" },
            c = { "", "Not defined" },
            l = { "", "Not defined" },
        },
    }
